...
int main()
{
	...
	float d = 3.14159; // 4 bytes  | Precisión aproximada de 6-7 dígitos

	long e = 980000000;			  // 4 bytes  | Rango desde -2 147 483 648 -> 2 147 483 647
	double f = 2.718281828459045; // 8 bytes  | Precisión de 15-16 dígitos

	unsigned int g = 123;			   // 4 bytes  | Rango desde 0 -> 4 294 967 295
	long double h = 12.33333232323232; // 16 bytes | Precisión de 15-16 dígitos
